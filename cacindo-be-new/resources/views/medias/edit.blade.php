    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.medias.update', $media->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title"
                                    placeholder="Training Name" style="color: #656773;" value="{{ $media->title ?? '' }}"
                                    required>
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="short_description" id="short_description" rows="10" class="form-control" style="color: #656773;">{{ @$media->short_description }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="body" id="body" rows="10" class="form-control">{!! $media->body ?? 'Content' !!}</textarea>
                                @error('body')
                                <div class="text-sm text-danger">{{ $message ?? 'Something error' }}</div>
                                @enderror
