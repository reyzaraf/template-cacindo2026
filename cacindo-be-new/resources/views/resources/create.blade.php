    ...
    <div class="container-fluid">
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.trainings.index') }}">Events</a></li>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.events.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="body" id="body" rows="10" class="form-control">{!! @$event->body ?? 'Content' !!}</textarea>
                                @error('body')
                                    <div class="text-sm text-danger">{{ $message ?? 'Something error' }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <textarea name="short_description" id="short_description" rows="10" class="form-control" style="color: #656773;">{{ @$event->short_description }}</textarea>
