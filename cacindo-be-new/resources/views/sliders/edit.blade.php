                        ...
                        <form action="{{ route('admin.sliders.update', $slider->id) }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title"
                                    placeholder="Training Name" style="color: #656773;" value="{{ $slider->title ?? '' }}"
                                    required>
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <input name="position" id="position" rows="10" class="form-control" style="color: #656773;" type="number" value="{{ @$slider->position }}">
                                @error('position')
                                    <div class="text-sm text-danger">{{ $message ?? 'Something error' }}</div>
                                @enderror
                            </div>
