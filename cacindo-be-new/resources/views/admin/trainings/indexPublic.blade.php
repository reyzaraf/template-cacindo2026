...
@section('content')
    ...
    <div class="content-wrapper oh">
        ...
        <section class="section-wrap pb-72 pb-lg-40 relative" id="trainings">
            <div class="container">
                <div class="justify-content-around row">
                    @foreach ($services as $service)
                        <div class="col-md-6 col-lg-3 mb-3" id="std">
                            <div>
            ...
            <div class="container">
                ...
                <div class="row text-center pt-4">
                    <div class="col-lg-4 col-md-4 mb-3">
                        <div class="wrapper">
                            <img src="{{ asset('ssi-fe/src/icons/metodologi-trainings/presentation-icon.svg') }}"
                                alt="" class="icon" />
                            <h5 class="mt-2">Tatap Muka <br> Langsung</h5>
                            <p>(Dilakukan dilokasi organisasi
                                atau public training)</p>
                        </div>
                    </div>

                    <div class="col-lg-4 col-md-4 mb-3">
                        <img src="{{ asset('ssi-fe/src/icons/metodologi-trainings/online-class-icon.svg') }}" alt=""
                            class="icon" />
                        <div class="wrapper">
                            <h5 class="mt-2">Pelatihan<br />Awareness</h5>
                            <p>(Dilakukan dengan media
                                online yang tersedia)</p>
                        </div>
                    </div>

                    <div class="col-lg-4 col-md-4 mb-3">
                        <div class="wrapper">
                            <img src="{{ asset('ssi-fe/src/icons/metodologi-trainings/movie-player.svg') }}" alt=""
                                class="icon" />
                            <h5 class="mt-2">Sistem Desain dan<br />Pengembangan</h5>
                            <p>(Dengan mengunduh video/
                                materi pelatihan)</p>
                        </div>
                    </div>
                </div>
