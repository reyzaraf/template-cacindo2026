                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.certificates.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="issue_date" class="text-capitalize">Mulai Training</label>
                            ...
                            <div class="form-group">
                                <label for="expiry_date" class="text-capitalize">Selesai Training</label>
                            ...
                            {{-- <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="status" name="status"
                                    placeholder="Status" style="color: #656773;" value="{{ old('status') }}" required>
                                @error('status')
                                    <div class="text-sm text-danger">{{ $message ?? 'Something error' }}</div>
                                @enderror
                            </div> --}}
